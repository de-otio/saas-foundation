...
export class SessionCookie {
  ...
  private primaryKeyPromise: Promise<webcrypto.CryptoKey> | null = null;
  private fallbackKeyPromise: Promise<webcrypto.CryptoKey> | null = null;
  ...
  private getPrimaryKey(): Promise<webcrypto.CryptoKey> {
  ...
  private getFallbackKey(): Promise<webcrypto.CryptoKey> | null {
    if (this.fallbackSecret === undefined) {
      return null;
    }
